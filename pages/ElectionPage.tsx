        ...
        <div className="animate-fade-in container mx-auto px-4 py-16">
            ...
            {!currentUser || currentUser.role !== 'member' ? (
                <div className="text-center bg-yellow-100 dark:bg-yellow-900/50 border-l-4 border-yellow-500 text-yellow-700 dark:text-yellow-300 p-4 rounded-md">
                    <p>You must be a logged-in member to vote. <Link to="/login" className="font-bold underline hover:text-yellow-800 dark:hover:text-yellow-100">Login here</Link>.</p>
                </div>
            ) : hasVoted ? (
                 <div className="text-center bg-green-100 dark:bg-green-900/50 border-l-4 border-green-500 text-green-700 dark:text-green-300 p-4 rounded-md">
